...
def command_for(preset, seed, fold_indices):
    ...
    if preset == "smoke":
        return common + [
            ...
            "--hard3-dual-view-set-shortlist",
            "16",
            "--hard3-dual-view-set-width",
            "8",
            "--hard3-dual-view-set-epochs",
            "2",
            "--hard3-dual-view-set-min-epochs",
            "1",
            "--hard3-dual-view-set-patience",
            "1",
            "--hard3-dual-view-set-candidate-dropout",
            "0.0",
