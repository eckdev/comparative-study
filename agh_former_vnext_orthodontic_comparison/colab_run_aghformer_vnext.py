...
def command_for(preset, seed, fold_indices):
    ...
    if preset == "smoke":
        return common + [
            ...
            "4",
            "--hard3-dual-view-rerank-stage-epochs",
            "1",
            "--hard3-dual-view-rerank-stage-min-epochs",
            "1",
            "--hard3-dual-view-rerank-stage-patience",
            "1",
    ...
    command = common + [
        ...
        "0",
        "--hard3-dual-view-rerank-sigma",
        "2.0",
        "--hard3-dual-view-rerank-temperature",
        "0.75",
        "--hard3-dual-view-rerank-expected-distance-weight",
        "0.5",
        "--hard3-dual-view-rerank-ordinal-weight",
        "0.25",
        "--hard3-dual-view-rerank-negative-radius-mm",
        "3.0",
        "--hard3-dual-view-rerank-stage-epochs",
        "40",
        "--hard3-dual-view-rerank-stage-min-epochs",
        ...
        "--hard3-dual-view-rerank-stage-patience",
        "10",
        "--hard3-dual-view-rerank-stage-lr",
        "0.0005",
        "--hard3-dual-view-pair-stage-epochs",
        "40",
        "--hard3-dual-view-pair-stage-min-epochs",
